...
### Define user entities in backstage
  ...
  Before users can login via GitHub in backstage, there needs to be a matching User entity in `https://github.com/fergalsomers/kubrix-test/blob/main/backstage-resources/entities/all.yaml`
